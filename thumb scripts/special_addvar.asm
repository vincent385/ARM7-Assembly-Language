...
main:
    @ push the registers to be used and link register onto stack
    push {r0-r1, lr}
    ...
    @ load the address of 0x800D again because we lost it after line 16
    ldr r1, =(0x20370D0)

    @ store the value in r0 at the address stored in r1
    strh r0, [r1]

    @ pop the registers used and program counter
    pop {r0-r1, pc}
